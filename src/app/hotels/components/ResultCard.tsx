...
const ResultCard = React.memo(function ResultCard({
  ...
  return (
    <div
      className="bg-gray-800 rounded-lg p-6 hover:bg-gray-750 transition-colors stagger-fade-in"
          ...
          {safeHref(result.url) && (
            <p className="text-sm text-green-400 truncate mb-2 flex items-center gap-1.5">
              ...
              <button
                ...
                className="flex-shrink-0 p-0.5 text-gray-400 hover:text-sky-400 transition-colors"
                title="Copy URL"
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`p-2 transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${
              isCompared ? "text-purple-400" : "text-gray-400 hover:text-purple-400"
            }`}
