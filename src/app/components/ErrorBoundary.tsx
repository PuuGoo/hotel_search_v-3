          ...
          <div className="w-full max-w-md rounded-xl border border-gray-200 bg-white p-8 text-center shadow-2xl dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="flex justify-center gap-3">
              ...
              <button
                ...
                className="rounded-lg border border-gray-300 bg-gray-100 px-5 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-ink"
              >
                Báo lỗi
              </button>
            </div>
